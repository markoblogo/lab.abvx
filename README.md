...
- [ABVX Agent Skills](https://lab.abvx.xyz/tools/abvx-agent-skills/) for validation-gated workflow rules that decide when to use MCP, when to use CLI, when to keep output reversible, how to enrich durable knowledge, establish evidence-backed product context, and which proof, review, or loop-readiness gates are required.
