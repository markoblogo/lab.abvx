...
- [SET](https://lab.abvx.xyz/tools/set/) for one CI entrypoint that keeps repo AI surfaces up to date and exports proposal-lifecycle, review-hint, optional shadow-first governance, and disabled L1/L2 loop-readiness contracts for downstream runners.
